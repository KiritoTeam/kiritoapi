...
async function fetchLatestVersion() {
    try {
        ...
        console.error("[update-checker] Falha ao buscar versão:", err.message);
        return null;
    }
}
/**
...
export async function checkForUpdates() {
    ...
    if (semver.gt(latestVersion, currentVersion)) {
        ...
        const reset = "\x1b[0m";
        console.log(`${orange}Você está usando uma versão desatualizada da ${PACKAGE_NAME} (atual: ${currentVersion}).\n` +
